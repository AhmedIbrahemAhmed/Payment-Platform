...
public class Wallet implements Provider{
    ...
    public boolean verify(String phoneNumber) {
        String filePath = "walletDummyDB.txt";
    ...
    public void  setBalance(double balance,String phoneNumber) {
        try {
            File inputFile = new File("walletDummyDB.txt");
            File tempFile = new File("tempwalletDummyDB.txt");
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 2) {
                    ...
                    writer.write(phoneNumber + " " + tempbalance);
                    writer.newLine();
                } else {
                    System.out.println("Invalid line format: " + line);
                }
