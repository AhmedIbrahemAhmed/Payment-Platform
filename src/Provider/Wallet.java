...
public class Wallet implements Provider{
    ...
    public boolean verify(String phoneNumber) {
        String filePath = "src/Provider/walletDummyDB.txt";
    ...
    public void  setBalance(double balance,String phoneNumber) {
        try {
            File inputFile = new File("src/Provider/walletDummyDB.txt");
            File tempFile = new File("src/Provider/tempwalletDummyDB.txt");
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 2) {
                    ...
                    if (tempphoneNumber.equals(phoneNumber)) {
                        tempbalance =tempbalance+ balance; 
                        System.out.print(tempbalance);
                    }
